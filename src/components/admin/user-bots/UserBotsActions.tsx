...
import { Search, Filter, Play, Pause, Download, X, Trash2 } from "lucide-react";
import { Input } from "@/components/ui/input";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from "@/components/ui/dropdown-menu";
import { FileSpreadsheet } from "lucide-react";

interface UserBotsActionsProps {
  searchTerm: string;
  ...
  exportToExcel: () => void;
  exportToJSON: () => void;
  openBulkActionDialog: (action: 'activate' | 'deactivate' | 'delete') => void;
}

export const UserBotsActions: React.FC<UserBotsActionsProps> = ({
  searchTerm,
  filterStatus,
  selectedBots,
  onSearchChange,
    ...
    <div className="flex flex-col gap-4 mb-6">
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <div className="relative w-full sm:max-w-[400px]">
          ...
          <Input 
            placeholder="Tìm kiếm Bot theo tên, ID, hoặc User ID..." 
