...
import { AlertTriangle, ChevronDown, ChevronRight, Code, Database, RefreshCw, Server, Shield, Signal, Users, Briefcase } from 'lucide-react';
            ...
            <div className="relative pl-8 py-4">
              ...
              <div className="relative mb-6">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xs text-muted-foreground">{formatTime(signal.timestamp)}</p>
                  <p className="text-sm mt-1">Prop Trading Bot {signal.botName} bắt đầu xử lý tín hiệu</p>
                </div>
              </div>
